...
ALTER TABLE "profile" ADD COLUMN "profile_image_content" "bytea";--> statement-breakpoint
ALTER TABLE "profile" ADD COLUMN "profile_image_content_hash" text;--> statement-breakpoint
ALTER TABLE "profile" ADD COLUMN "profile_image_file_type" text;--> statement-breakpoint
...
ALTER TABLE "profile" DROP COLUMN "profile_image_url";--> statement-breakpoint
...
ALTER TABLE "profile" ADD CONSTRAINT "profile_image_content_hash_format_chk" CHECK ("profile"."profile_image_content_hash" ~ '^[0-9a-f]{64}$');--> statement-breakpoint
